...
namespace nwr {
    ...
    Token LexerCPP::nextToken() {
        ...
        if(token.getType() == t_ID) {
            ...
            addKeyword("const", t_SPECIFIER);
            addKeyword("consteval", t_SPECIFIER);
            addKeyword("constexpr", t_SPECIFIER);
            addKeyword("constinit", t_SPECIFIER);
            ...
            addKeyword("override", t_SPECIAL);
            addKeyword("pragma", t_DIR);
            addKeyword("private", t_SPECIFIER);
            addKeyword("protected", t_SPECIFIER);
            addKeyword("public", t_SPECIFIER);
            ...
            addKeyword("signed", t_SPECIFIER);
            addKeyword("sizeof", t_SIZEOF);
            addKeyword("static", t_SPECIFIER);
            ...
            addKeyword("unsigned", t_SPECIFIER);
            addKeyword("using", t_USING);
            addKeyword("virtual", t_SPECIFIER);
            addKeyword("void", t_SPECIFIER);
            addKeyword("volatile", t_SPECIFIER);
